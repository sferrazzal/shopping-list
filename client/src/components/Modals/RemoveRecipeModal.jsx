    ...
    return (
        <>
            ...
            <Modal show={show} onHide={() => handleHide()}>
                ...
                <Modal.Body>
                    <div className="text-center fw-bold fs-5 mb-3">Removing recipe "{props.recipe.title}" will remove these items from the list. Proceed?</div>
                    <div className='row'>
                        <div className="col text-center fw-bold">Item</div>
                        <div className="col text-center fw-bold">Quantity</div>
                    </div>
